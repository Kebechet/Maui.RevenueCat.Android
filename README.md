...
- if you would like to have everything up to date then you can include all latest versions direcly inside the binding like: https://github.com/dotnet/maui/issues/17826
